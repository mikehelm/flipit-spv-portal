...
**And it will come and find you.** On the overview — the first screen after you sign in — there is a card linking to System health, and above it, *only when something actually needs you*, a line saying so. On a healthy system that line is not there at all. That is deliberate: a banner that says "everything is fine" every morning is a banner nobody reads on the morning it says otherwise. The card is always there, so a missing banner never leaves you wondering whether anything looked.
