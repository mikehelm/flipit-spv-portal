...
| --- | --- | --- | --- |
| Guided release mobile acceptance blockers | root-goal-viewport | 2026-07-28 09:43 | `src/components/text-size-control.tsx`, `src/components/account-curl-menu.tsx`, `src/app/(admin)/audit/page.tsx`, `src/lib/portal/demo-preview.test.ts`, `scripts/verify-viewport.ts`, `GUIDED_RELEASE_RECEIPT.md`, `PROGRESS.md`, `CLAIMS.md` |
