...
| Mike, David, and John Doe view switcher | Codex root | 2026-07-27 08:59 UTC | `src/components/portal-preview-switch.tsx`; `src/app/globals.css`; `src/app/(admin)/layout.tsx`; `src/app/portal/page.tsx`; `src/lib/portal/demo-preview.test.ts`; `PROGRESS.md` |
